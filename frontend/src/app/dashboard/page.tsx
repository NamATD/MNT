      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-4">
            <button onClick={() => router.push("/dashboard/create")} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
              Create New Task
            </button>
            <button
              onClick={() => {
                ...
                {tasks.map((task) => (
                  <tr key={task._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button onClick={() => router.push(`/dashboard/${task._id}`)} className="text-blue-600 hover:text-blue-900 mr-4">
                        View
                      </button>
                      <button onClick={() => router.push(`/dashboard/${task._id}/edit`)} className="text-indigo-600 hover:text-indigo-900 mr-4">
                        Edit
                      </button>
